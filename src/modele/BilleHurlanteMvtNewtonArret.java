 ...
 *
 * Cette bille "hurle" aussi. Elle émet un son continu qui varie en fct de sa
 * vitesse et de sa position.
 * 
 * Le son est stéréo. la balance est déterminée par la position (abscisse) de la
 * bille Le volume du son et la fréquence d'émissions augmentent avec la vitesse
 * de la bille
 * 
 * 
 * 
