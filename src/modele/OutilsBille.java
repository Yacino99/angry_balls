 ...
 * @return la liste des autres billes que cetteBille, c'est-é-dire la liste de toutes les billes sauf cetteBille 
 * 
 * */
...
/**
 * @param cetteBille : une bille particuliére
 ...
 * 
 * Le comportement par défaut est le choc parfaitement élastique (c-é-d rebond sans amortissement)
 * 
...
{
//--- on récupére d'abord dans autresBilles toutes les billes sauf cetteBille ----

Vector<Bille> autresBilles = OutilsBille.autresBilles(cetteBille, billes);

//--- on cherche é présent la 1ére des autres billes avec laquelle cetteBille est en collision ---------------------
//-------------- on suppose qu'il ne peut y avoir de collision qui implique plus de deux billes é la fois ---------------
 ...
 * 
 * téche : calcule a, le vecteur accélération subi par cetteBille résultant de l'attraction par les autres billes de la liste.
 * 
...
//--- on récupére d'abord dans autresBilles toutes les billes sauf celle-ci ----

Vector<Bille> autresBilles = OutilsBille.autresBilles(cetteBille, billes);

//-------------- é présent on récupére les masses et les positions des autres billes ------------------
int i;
Bille billeCourante;
...
//------------------ é présent on calcule le champ de gravité exercé par les autres billes sur cette bille ------------------
